...
CAT_URL = reverse("store:category_list")


def detail_url(category_uid):
    return reverse("store:category_detail", args=[category_uid])
...
class PublicApiTest(TestCase):
    """Test the public API of the Category api."""
